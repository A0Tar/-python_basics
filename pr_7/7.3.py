...
class Cell:
    ...
    def __add__(self, other):
        return f'Объединение ячеек. Размер клетки равен: {self.quantity + other.quantity}'

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f'Вычитание ячеек. Размер клетки равен: {sub} ячеек' if sub > 0 else 'Клетка разрушена'

    def __truediv__(self, other):
        return f'Деление ячеек. Размер клетки равен: {self.quantity // other.quantity}'

    def __mul__(self, other):
        return f'Умножение ячеек. Размер клетки равен: {self.quantity * other.quantity}'
